...
// 27Jul17 added stationOnly parameter /jc
AdafruitIO_ESP8266::AdafruitIO_ESP8266(const char *user, const char *key, const char *ssid, const char *pass, WiFiMode_t theMode):AdafruitIO(user, key)
{
  _ssid = ssid;
  _pass = pass;
